...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    sidebarUserPanel(
      "DSLA Team - Nazima Khan and Murli k"),
    
    sidebarMenu(
      menuItem("Dashboard", tabName = "dashboard", icon = icon("dashboard")),
      menuItem("Step 1- Is Ride Available", tabName = "when", icon = icon("calendar-times-o")),
      menuItem("Step 2- Which Location", tabName = "where", icon = icon("map-marker")),
  ...
  dashboardBody(
    tabItems(
    tabItem(tabName = 'Best Day and Time',
            fluidRow(
    ...
    tabItem(tabName = "Show directions",
